...
function ModalAddUrl({ isOpen, onClose }) {
    ...
    function addBlockedUrl(urlToAdd) {
        urlToAdd = (0,_helper_urlHelpers__WEBPACK_IMPORTED_MODULE_4__.transformUserInputToValidURL)(urlToAdd);
        chrome.storage.local.get(["blockedUrlData"], (result) => {
            if (result.blockedUrlData) {
                const updatedBlockedUrls = Object.assign({}, result.blockedUrlData);
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("dialog", { className: "dialog-container", ref: dialogRef, onClose: handleClose },
        ...
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_urlInput__WEBPACK_IMPORTED_MODULE_3__["default"], { handleClose: handleClose, addBlockedUrl: addBlockedUrl })));
}
    ...
    const blockSettings = [
        {
            ...
            title: "Hides entire websites from the search results, includes the <Related Questions> section ",
        },
        {
        ...
        },
        {
            ...
            title: "Hides videos in the dedicated video section in search results. Does not affect videos appearing in regular web results",
        },
        {
            settingName: "Block news",
            googleStorageKey: "blockNews",
            title: "Hides results in the dedicated news section in search results. Does not affect news articles appearing in regular web results",
        },
        {
